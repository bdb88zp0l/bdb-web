    ...
    <div className="xl:col-span-4 col-span-12">
      <div className="box custom-box">
        <div className="box-header">
          <div className="box-title !text-start">Client Code Setup</div>
        </div>
        <div className="box-body">
          <p>
            Configure unique client codes that can be used to identify and
            categorize your clients. Each client code should be unique and
            meaningful, helping you to easily manage and track client
            information. To add a new client code, enter the code below and
            press <b>Enter</b>.
          </p>
