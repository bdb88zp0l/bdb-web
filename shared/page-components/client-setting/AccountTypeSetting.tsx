...
export default function AccountTypeSetting() {
  ...
  useEffect(() => {
    setValues(config?.CLIENT_ACCOUNT_TYPE ?? []);
  }, [config?.CLIENT_ACCOUNT_TYPE]);
    ...
    <div className="xl:col-span-4 col-span-12">
      <div className="box custom-box">
        <div className="box-header">
          <div className="box-title !text-start">Account Type Setup</div>
        </div>
        <div className="box-body">
          <p>
            Define the types of accounts available for your users. This setup
            allows you to categorize the different account types your system
            will support, such as "Individual," "Corporate," etc. To add a new
            account type, enter the account type name below and press
            <b> Enter</b>.
          </p>
