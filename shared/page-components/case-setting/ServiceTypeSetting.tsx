...
export default function ServiceTypeSetting() {
  ...
  useEffect(() => {
    setValues(config?.CASE_SERVICE_TYPE ?? []);
  }, [config?.CASE_SERVICE_TYPE]);
    ...
    <div className="xl:col-span-4 col-span-12">
      <div className="box custom-box">
        <div className="box-header">
          <div className="box-title !text-start">Service Type Setup</div>
        </div>
        <div className="box-body">
          <p>
            Configure the types of services that your clients can select. This
            setup allows you to categorize the different services your business
            offers. To add a new service type, enter the service name below and
            press <b>Enter</b>.
          </p>
