...
const Modalsearch = () => {
  ...
  const tabsData = [
    { id: 1, class: "Litigation", icon: "user" },
    { id: 2, class: "Assessment", icon: "file-text" },
    { id: 3, class: "Corporate Service", icon: "align-left" },
    { id: 4, class: "Consultancy", icon: "server" },
  ];
...
*/}
            ...
            <div className="my-[1.5rem]">
              ...
              >
                <Link href="/pages/email/mail-app/">
                  <span>CAS-003 Caltex</span>
                </Link>
                <Link
                  aria-label="anchor"
