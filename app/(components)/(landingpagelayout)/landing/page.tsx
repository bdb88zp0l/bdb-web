                            ...
                            <nav className="main-menu-container nav nav-pills flex-column sub-open">
                                <div className="landing-logo-container my-auto hidden lg:block">
                                    <div className="responsive-logo">
                                        <Link className="responsive-logo-light" href="/dashboard/" aria-label="Brand"><img
                                            src="../assets/images/brand-logos/desktop-logo.png" alt="logo" className="mx-auto" /></Link>
                                        <Link className="responsive-logo-dark" href="/dashboard/" aria-label="Brand"><img
                                ...
                                <div className="grid grid-cols-12 gap-6">
                                    <div className="xxl:col-span-7 xl:col-span-7 lg:col-span-6 col-span-12">
                                        <div className="xl:py-[3rem]">
                                            ...
                                            <Link href="/dashboard/" className="m-1 ti-btn ti-btn-primary-full">
                                                View Demos
                        ...
                        <div className="container">
                            <div className="grid grid-cols-12 gap-6">
                                <div className="xl:col-span-4 col-span-12">
                                    <div className="px-6">
                                        <p className="font-semibold mb-4"><Link aria-label="anchor" href="/dashboard/"><img src="../assets/images/brand-logos/desktop-dark.png" alt="" /></Link></p>
