          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="radialbar-basic">
                <ReactApexChart
                  options={Radialdata.Basicradialbar.options}
                  series={Radialdata.Basicradialbar.series}
                  type="radialBar"
                  width={"100%"}
                  height={300}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body !px-0">
              <div id="radialbar-multiple">
                <ReactApexChart
                  options={Radialdata.Multipleradial.options}
                  series={Radialdata.Multipleradial.series}
                  type="radialBar"
                  width={"100%"}
                  height={300}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body !sm:p-3 !p-2">
              <div id="circle-custom">
                <ReactApexChart
                  options={Radialdata.Circlechart.options}
                  series={Radialdata.Circlechart.series}
                  type="radialBar"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body !sm:p-3 !p-2">
              <div id="gradient-circle">
                <ReactApexChart
                  options={Radialdata.Gradientcircle.options}
                  series={Radialdata.Gradientcircle.series}
                  type="radialBar"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="circular-stroked">
                <ReactApexChart
                  options={Radialdata.Circlegauge.options}
                  series={Radialdata.Circlegauge.series}
                  type="radialBar"
                  width={"100%"}
                  height={320}
                />
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body !sm:p-3 !p-2">
              <div id="circle-image">
                <ReactApexChart
                  options={Radialdata.Circlewithimage.options}
                  series={Radialdata.Circlewithimage.series}
                  type="radialBar"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="circular-semi">
                <ReactApexChart
                  options={Radialdata.Semicirclegauge.options}
                  series={Radialdata.Semicirclegauge.series}
                  type="radialBar"
                  width={"100%"}
                  height={320}
                />
