        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="area-basic">
                <ReactApexChart
                  options={Areadata.Basicarea.options}
                  series={Areadata.Basicarea.series}
                  type="area"
                  width={"100%"}
                  height={300}
                />
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="area-spline">
                <ReactApexChart
                  options={Areadata.Spiline.options}
                  series={Areadata.Spiline.series}
                  type="area"
                  width={"100%"}
                  height={300}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="area-negative">
                <ReactApexChart
                  options={Areadata.Negative.options}
                  series={Areadata.Negative.series}
                  type="area"
                  width={"100%"}
                  height={300}
                />
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="area-stacked">
                <ReactApexChart
                  options={Areadata.Stacked.options}
                  series={Areadata.Stacked.series}
                  type="area"
                  width={"100%"}
                  height={350}
                />
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="area-null">
                <ReactApexChart
                  options={Areadata.Nullarea.options}
                  series={Areadata.Nullarea.series}
                  type="area"
                  width={"100%"}
                  height={350}
                />
