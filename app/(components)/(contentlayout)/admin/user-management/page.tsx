                    ...
                    <div className="p-6 border-b border-dashed border-defaultborder dark:border-defaultborder/10">
                        <div className="mb-0">
                            ...
                            <p className="text-[#8c9097] dark:text-white/50 op-8 mb-0">
                                I am{' '}
                                <b className="text-default">Lisa Convay,</b>{' '}
                                here by conclude that,i am the founder and
                                managing director of the prestigeous company
                                name laugh at all and acts as the cheif
                    ...
                    <div className="p-6 border-b border-dashed border-defaultborder dark:border-defaultborder/10">
                        ...
                        <div className="">
                            ...
                            <div className="flex items-center mb-0">
                                ...
                                <div>
                                    MIG-1-11, Monroe Street, Georgetown,
                                    Washington D.C, USA,20071
                                </div>
                            </div>
                        </div>
                    </div>
