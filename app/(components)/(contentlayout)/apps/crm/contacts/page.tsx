                    ...
                    <div className="box custom-box">
                        <div className="box-header flex items-center justify-between flex-wrap gap-4">
                            ...
                            <div className="flexflex-wrap gap-2">
                                ...
                                <button type="button" className="ti-btn ti-btn-success !py-1 !px-2 !text-[0.75rem] me-2">Export as XLSX</button>
                        ...
                        <div className="ti-modal-body px-4">
                            <div className="grid grid-cols-12 gap-4">
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                    <label htmlFor="basic" className="form-label">Basic Information</label>
                                </div>
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                    ...
                                    <input type="text" className="form-control" id="prefix" placeholder="Prefix" />
                                </div>                  
