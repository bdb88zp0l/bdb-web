                ...
                <div className="p-[3rem]">
                    ...
                    <div className="grid grid-cols-12 gap-y-4">
                        <div className="xl:col-span-12 col-span-12 mt-0">
                            ...
                            <input type="text" className="form-control form-control-lg w-full !rounded-md" id="signin-username" placeholder="Username"/>
                        </div>
                        <div className="xl:col-span-12 col-span-12">
                            <label htmlFor="signin-password" className="form-label text-default block">Password {/*}<Link href="/authentication/reset-password/reset-cover" className="ltr:float-right rtl:float-left text-danger">Forgot password?</Link>{*/}</label>
                    ...
                    <div className="text-center">
                        <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">If you haven't been granted access to the portal or are having trouble logging in, please reach out to your system administrator to ensure your account is set up correctly. Do not attempt to create an unauthorized account.</p>
                    </div>
                </div>
            </div>
            <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-3 sm:col-span-2"></div>
    ...
    <div className="xxl:col-span-5 xl:col-span-5 lg:col-span-5 col-span-12 xl:block hidden px-0">
        <div className="authentication-cover">
            <div className="aunthentication-cover-content rounded">
                ...
                <Swiper spaceBetween={30} navigation={true} centeredSlides={true} autoplay={{ delay: 10000, disableOnInteraction: false, }} pagination={{ clickable: true, }} modules={[Pagination, Autoplay, Navigation]} className="mySwiper">
                        <SwiperSlide>
                            <div className="text-white text-center p-[3rem] flex items-center justify-center">
                                <div>
                                    <div className="mb-[3rem]">
                                        <img src="../../../assets/images/authentication/cred.png" className="authentication-image" alt=""/>
                                    </div>
                                    <h6 className="font-semibold text-[1rem]">Protect Your Credentials</h6>
                                    <p className="font-normal text-[.875rem] opacity-[0.7]"> Never share your username or password with anyone. If you suspect that your login information has been compromised, change your password immediately and notify the IT department.</p>
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="text-white text-center p-[3rem] flex items-center justify-center">
                                <div>
                                    <div className="mb-[3rem]">
                                        <img src="../../../assets/images/authentication/2fa.png" className="authentication-image" alt=""/>
                                    </div>
                                    <h6 className="font-semibold text-[1rem]">Enable Two-Factor Authentication (2FA)</h6>
                                    <p className="font-normal text-[.875rem] opacity-[0.7]"> Ensure that you have 2FA enabled for an added layer of security. This helps protect your account even if your password is compromised.</p>
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="text-white text-center p-[3rem] flex items-center justify-center">
                                <div>
                                    <div className="mb-[3rem]">
                                        <img src="../../../assets/images/authentication/exit.png" className="authentication-image" alt=""/>
                                    </div>
                                    <h6 className="font-semibold text-[1rem]">Log Out When Finished</h6>
                                    <p className="font-normal text-[.875rem] opacity-[0.7]"> Always log out of your account when you're finished, especially if you're using a shared or public device. This helps prevent unauthorized access to your account.</p>
                                </div>
                            </div>
                        </SwiperSlide>
                    </Swiper>
